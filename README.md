...
This version has been tweaked to facilitate multiple instances with unique window and process names.
These tweaks and scripts were meant for Windows only.
